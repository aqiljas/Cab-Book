...
import com.mega.citycab.services.CustomersAddFeedbackRepository;
...
public class CustomersAddFeedbackController {
    ...
    public String vehicle(){
        return "customerinterfacebookacab/vehicles";
    } 

    @GetMapping("/blog-single")
    public String blogSingle(){
        return "customerinterfacebookacab/blog-single";
    } 
    ...
    @GetMapping("/menu")
    public String menu(){
        return "customerinterfacebookacab/menu";
    } 
